...
describe('Index', () => {
  ...
  describe('Custom', () => {
    ...
    it('setMask', () => {
      ...
      write(input, '2.500.02.510');
      assert.equal(input.value, 'R$25,000,251.000.');
      assert.equal(input.formatToNumber(), 25000251);      

      write(input, 'a1a.5b0-0.0*25+10');
      assert.equal(input.value, 'R$15,000,251.000.');
      assert.equal(input.formatToNumber(), 15000251);
