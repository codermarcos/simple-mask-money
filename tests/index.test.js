...
describe('Index', () => {
  describe('Default', () => {
    ...
    it('formatToNumber', () => {
      ...
      assert.equal(index.formatToNumber('2.500.025,10'), 2500025.10);
      assert.equal(index.formatToNumber('a1a.5b0-0.0*25+10'), 1500025.10);
      assert.equal(index.formatToNumber('1.500.025,10'), 1500025.10);
    });    
    ...
    it('setMask', () => {
      ...
      assert.equal(input.formatToNumber(), 2500025.10);      
      ...
      assert.equal(input.value, '1.500.025,10');
      assert.equal(index.formatToNumber(), 1500025.10);
    });
  });
  ...
  describe('Custom', () => {
    ...
    it('format', () => {
      ...
      assert.equal(index.format('2.500.02.510.'), 'R$250,002,510.000.');
      assert.equal(index.format('a1a.5b0-0.0*25+10.'), 'R$150,002,510.000.');
    });
    ...
    it('formatToNumber', () => {
      ...
      assert.equal(index.formatToNumber('R$250,002.510.'), 250002.510);
      assert.equal(index.formatToNumber('R$150,002.510.'), 150002.510);
    }); 
