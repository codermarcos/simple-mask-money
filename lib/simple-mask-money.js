  ...
  var core = function () {
    ...
    _createClass$1(Core, [{
      ...
      value: function mask(value) {
        ...
        var retorno = this.writingToNumber(value) || this.emptyOrInvalid();
  ...
  var implanter = {
    ...
    addMask: function addMask(input, core) {
      ...
      input.addEventListener('input', function (e) {
        ...
        var oldCaretPosition = _this.getCaretPosition(input);
        var newCaretPosition = _this.indexMove(newValue, oldValue, oldCaretPosition);
        ...
        _this.setCaretPosition(input, newCaretPosition);
        !(e instanceof Event) && _this.refreshMask(input);
      });
    },
  ...
  var src = function () {
    ...
    _createClass$2(SimpleMaskMoney, null, [{
      ...
      value: function format(value, args$$1) {
        ...
        return '' + (!core$$1.args.negativeSignAfter && negative ? '-' : '') + formatation + (core$$1.args.negativeSignAfter && negative ? '-' : '');
      }
    }, {
      key: 'formatToNumber',
